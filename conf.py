...
BLOG_AUTHOR = "Obsa Aba-waji"  # (translatable)
BLOG_TITLE = "Learning Blog"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://southernblacknerd.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://southernblacknerd.github.io/"
BLOG_EMAIL = "oabawaji@gmail.com"
BLOG_DESCRIPTION = "Blog to track my progress and thoughts about topics in the computer science field"  # (translatable)
